package com.example.rasool.data.auth
...
import com.example.rasool.GoogleServerClientID
import com.example.rasool.data.models.GoogleAccount
...
class GoogleAuthUiProvider {
    suspend fun signIn(
        ...
        // Getting the credential from google
